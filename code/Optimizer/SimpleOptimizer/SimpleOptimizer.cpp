...
void SimpleOptimizer::optimize(std::vector<std::shared_ptr<Organism>> &population) {
	...
	if (nextPopulationTargetSize == -1) {
    	...
    	std::cout << "\n  nextPopulationTargetSize: " << nextPopulationTargetSize << "\n";
	...
	int population_size_debug_baba = population.size();
    	std::cout << "\n  population size debug baba: " << population_size_debug_baba << "\n";
	...
	*/
	...
	int population_size_debug_bardbee = population.size();
    	std::cout << "\n  population size debug bardbee: " << population_size_debug_bardbee << "\n";
	...
	int population_size_debug_badabing = population.size();
    	std::cout << "\n  population size debug badabing: " << population_size_debug_badabing << "\n";
